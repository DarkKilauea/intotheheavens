...
{
    Pattern _regex = Pattern.compile("^load_game\\s*(\\w+)?\\s*$", Pattern.CASE_INSENSITIVE);
    
    public LoadGameCommand(String name)
    {
        super(name);
    }
    ...
    {
        return "Loads a game from the specified save name.";
    }
    
    @Override
    public String getHelpText()
    {
        return "Usage: load_game [game name]";
    }
}
