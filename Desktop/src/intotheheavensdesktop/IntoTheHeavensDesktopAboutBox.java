/*
 * IntoTheHeavensDesktopAboutBox.java
 */
...
public class IntoTheHeavensDesktopAboutBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(intotheheavensdesktop.IntoTheHeavensDesktopApp.class).getContext().getResourceMap(IntoTheHeavensDesktopAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(intotheheavensdesktop.IntoTheHeavensDesktopApp.class).getContext().getActionMap(IntoTheHeavensDesktopAboutBox.class, this);
